 ...
 */
public class NotesListAdapterOld extends RecyclerView.Adapter<NotesListAdapterOld.NoteViewHolder> {
	...
	public NotesListAdapterOld(Context context, List<Note> notes, NoteViewHolder.OnInteractionListener onInteractionListener) {
	...
	public static class NoteViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener, CompoundButton.OnCheckedChangeListener {
		...
		public NoteViewHolder(View itemView, OnInteractionListener listener) {
			...
			mNoteCheckbox = (CheckBox)itemView.findViewById(R.id.note_check_box);
